...
| **DeepSeek Harness (DSH)** | `dsh plugin --profile <profile> add -w github:HelloiOS2014/AnythingUse` *(or `./scripts/install-dsh.sh [profile]`; see [`dsh/README.md`](dsh/README.md))* |
